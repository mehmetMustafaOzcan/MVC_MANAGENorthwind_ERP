...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.Employee", b =>
                {
                    b.Property<int>("EmployeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.OrderDetail", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.Region", b =>
                {
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.Shipper", b =>
                {
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.Territory", b =>
                {
                    b.Property<string>("TerritoryId")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("EmployeeTerritory", b =>
                {
                    b.HasOne("ManageTheNorthwind.Models.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .IsRequired()
                        .HasConstraintName("FK_EmployeeTerritories_Employees");

                    b.HasOne("ManageTheNorthwind.Models.Territory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.Employee", b =>
                {
                    b.HasOne("ManageTheNorthwind.Models.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.Order", b =>
                {
                    b.HasOne("ManageTheNorthwind.Models.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_Orders_Customers");

                    b.HasOne("ManageTheNorthwind.Models.Employee", "Employee")
                        .WithMany("Orders")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_Orders_Employees");

                    b.HasOne("ManageTheNorthwind.Models.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.OrderDetail", b =>
                {
                    b.HasOne("ManageTheNorthwind.Models.Order", "Order")
                    ...
                    b.HasOne("ManageTheNorthwind.Models.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.Product", b =>
                {
                    b.HasOne("ManageTheNorthwind.Models.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("FK_Products_Categories");

                    b.HasOne("ManageTheNorthwind.Models.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ManageTheNorthwind.Models.Territory", b =>
                {
                    b.HasOne("ManageTheNorthwind.Models.Region", "Region")
