...
const cardChart1 = new Chart(document.getElementById('card-chart1'), {
  type: 'line',
  data: {
    labels: ['januaryocak', 'February', 'March', 'April', 'May', 'June', 'July'],
    datasets: [{
      label: 'Benim dataset',
...
const cardChart4 = new Chart(document.getElementById('card-chart4'), {
  type: 'bar',
  data: {
    labels: ['januaryocak', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December', 'januaryocak', 'February', 'March', 'April'],
    datasets: [{
      label: 'Benim dataset',
      backgroundColor: 'rgba(255,255,255,.2)',
      borderColor: 'rgba(255,255,255,.55)',
...
const brandBoxChartLabels = ['januaryocak', 'February', 'March', 'April', 'May', 'June', 'July'];
